    ...
    <div className='w-9/10 container mx-auto px-5 md:px-0'>
        <div className='h-[200px] flex flex-col justify-center relative z-10'>
            <div className='flex items-start'>
                <button
                    onClick={() => navigate(-1)}
                    className='flex items-center justify-center h-9 w-9 rounded-full border border-gray-200 bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition mr-3 flex-shrink-0 cursor-pointer'
                    aria-label='Go back'
                >
                    <LuArrowLeft size={18} />
                </button>
